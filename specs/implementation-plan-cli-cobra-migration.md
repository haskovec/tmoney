...
- [x] **CM-034 — `tmoney security hide <ticker>`** (completed 2026-05-08)
...
- [x] **CM-035 — `tmoney security unhide <ticker>`** (completed 2026-05-08)
...
- [x] **CM-036 — `tmoney security delete <ticker>`** (completed 2026-05-08)
...
- [x] **CM-046 — `tmoney investment dividend`** (completed 2026-05-08) — covers `TestRun_Dividend*`.
- [x] **CM-047 — `tmoney investment reinvest`** (completed 2026-05-08) — covers `TestRun_Reinvest*`.
