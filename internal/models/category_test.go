...
func TestCategoryType(t *testing.T) {
	t.Run("AllCategoryTypes returns all types", func(t *testing.T) {
		types := AllCategoryTypes()
		expected := 2
		if len(types) != expected {
			t.Errorf("Expected %d category types, got %d", expected, len(types))
		}
	})

	t.Run("String returns correct value", func(t *testing.T) {
		if CategoryTypeIncome.String() != "income" {
			t.Errorf("Expected 'income', got %q", CategoryTypeIncome.String())
		}
		if CategoryTypeExpense.String() != "expense" {
			t.Errorf("Expected 'expense', got %q", CategoryTypeExpense.String())
		}
	})
...
func TestParseCategoryType(t *testing.T) {
	t.Run("Parses valid income type", func(t *testing.T) {
		ct, err := ParseCategoryType("income")
		if err != nil {
			t.Errorf("Unexpected error: %v", err)
		}
		if ct != CategoryTypeIncome {
			t.Errorf("Expected CategoryTypeIncome, got %q", ct)
		}
	})

	t.Run("Parses valid expense type", func(t *testing.T) {
		ct, err := ParseCategoryType("expense")
		if err != nil {
			t.Errorf("Unexpected error: %v", err)
		}
		if ct != CategoryTypeExpense {
			t.Errorf("Expected CategoryTypeExpense, got %q", ct)
		}
	})
	...
	t.Run("Returns error for invalid type", func(t *testing.T) {
		_, err := ParseCategoryType("invalid")
		if err == nil {
...
func TestCategoryTypeScanValue(t *testing.T) {
...
func TestNewCategory(t *testing.T) {
	t.Run("Creates top-level income category", func(t *testing.T) {
		cat := NewCategory("Salary", CategoryTypeIncome)
		...
		if cat.Type != CategoryTypeIncome {
	...
	t.Run("Creates top-level expense category", func(t *testing.T) {
		cat := NewCategory("Food", CategoryTypeExpense)
...
func TestNewSubcategory(t *testing.T) {
	t.Run("Creates subcategory with parent", func(t *testing.T) {
		parentID := NewID()
		cat := NewSubcategory("Groceries", parentID, CategoryTypeExpense)
...
func TestNewSystemCategory(t *testing.T) {
	t.Run("Creates system category", func(t *testing.T) {
		cat := NewSystemCategory("Transfer", CategoryTypeExpense)
...
func TestCategorySetParent(t *testing.T) {
	t.Run("SetParent sets parent ID", func(t *testing.T) {
		cat := NewCategory("Groceries", CategoryTypeExpense)
		parentID := NewID()
...
func TestCategoryValidation(t *testing.T) {
	validCategory := func() *Category {
		return NewCategory("Test Category", CategoryTypeExpense)
	}
...
func TestCategoryIsValid(t *testing.T) {
	t.Run("IsValid returns false for invalid category", func(t *testing.T) {
		cat := NewCategory("", CategoryTypeExpense) // Empty name
		if cat.IsValid() {
