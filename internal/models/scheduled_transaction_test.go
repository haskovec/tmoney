...
func TestNewScheduledTransaction(t *testing.T) {
	t.Run("Creates scheduled transaction with required properties", func(t *testing.T) {
		accountID := NewID()
		startDate := NewDate(2024, time.January, 15)

		st := NewScheduledTransaction(accountID, FrequencyMonthly, startDate)

		if st.ID.IsNil() {
			t.Error("NewScheduledTransaction should create non-nil ID")
		}
...
func TestNewScheduledTransactionWithAmount(t *testing.T) {
	t.Run("Creates scheduled transaction with amount", func(t *testing.T) {
		accountID := NewID()
		startDate := NewDate(2024, time.January, 15)
		amount := MustNewMoney("-1500.00")

		st := NewScheduledTransactionWithAmount(accountID, FrequencyMonthly, startDate, amount)
...
func TestNewScheduledTransactionFull(t *testing.T) {
	t.Run("Creates scheduled transaction with all properties", func(t *testing.T) {
		...
		st := NewScheduledTransactionFull(accountID, FrequencyMonthly, startDate, amount, payeeID, categoryID, memo)
	...
	t.Run("Handles nil payee and category", func(t *testing.T) {
		...
		st := NewScheduledTransactionFull(accountID, FrequencyMonthly, startDate, amount, NilID, NilID, "")
...
func TestScheduledTransactionPayee(t *testing.T) {
...
func TestScheduledTransactionCategory(t *testing.T) {
...
func TestScheduledTransactionAmount(t *testing.T) {
	t.Run("SetAmount sets amount", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, Today())
		amount := MustNewMoney("-100.00")
	...
	t.Run("ClearAmount marks as variable", func(t *testing.T) {
		st := NewScheduledTransactionWithAmount(NewID(), FrequencyMonthly, Today(), MustNewMoney("-100.00"))
...
func TestScheduledTransactionMemo(t *testing.T) {
...
func TestScheduledTransactionEndDate(t *testing.T) {
	t.Run("SetEndDate sets end date and clears occurrences", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, NewDate(2024, time.January, 1))
		st.SetOccurrences(12)

		endDate := NewDate(2024, time.December, 31)
	...
	t.Run("ClearEndDate removes end date", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, Today())
		st.SetEndDate(NewDate(2025, time.December, 31))
...
func TestScheduledTransactionOccurrences(t *testing.T) {
	t.Run("SetOccurrences sets occurrences and remaining", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, NewDate(2024, time.January, 1))
		st.SetEndDate(NewDate(2024, time.December, 31))
...
func TestScheduledTransactionDaySettings(t *testing.T) {
	...
	t.Run("SetDayOfWeek sets day of week", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyWeekly, Today())
...
func TestScheduledTransactionAmountEstimate(t *testing.T) {
...
func TestScheduledTransactionInterval(t *testing.T) {
...
func TestScheduledTransactionState(t *testing.T) {
	...
	t.Run("IsDue returns false when next date is in the future", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, Today().AddDays(7))
	...
	t.Run("IsCompleted returns true when next date is past end date", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, NewDate(2024, time.January, 1))
		st.SetEndDate(NewDate(2024, time.December, 31))
		st.NextDate = NewDate(2025, time.January, 1)
...
func TestCalculateNextDate(t *testing.T) {
	t.Run("Daily adds interval days", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyDaily, NewDate(2024, time.January, 1))
		st.Interval = 1

		next := st.CalculateNextDate()

		expected := NewDate(2024, time.January, 2)
	...
	t.Run("Daily with interval 3", func(t *testing.T) {
		...
		expected := NewDate(2024, time.January, 4)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Weekly adds 7 days", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyWeekly, NewDate(2024, time.January, 1))

		next := st.CalculateNextDate()

		expected := NewDate(2024, time.January, 8)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Weekly with interval 2", func(t *testing.T) {
		...
		expected := NewDate(2024, time.January, 15)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Biweekly adds 14 days", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyBiweekly, NewDate(2024, time.January, 5))

		next := st.CalculateNextDate()

		expected := NewDate(2024, time.January, 19)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Monthly adds 1 month", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, NewDate(2024, time.January, 15))

		next := st.CalculateNextDate()

		expected := NewDate(2024, time.February, 15)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Monthly with interval 2", func(t *testing.T) {
		...
		expected := NewDate(2024, time.March, 15)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Monthly handles month-end adjustment", func(t *testing.T) {
		...
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, NewDate(2024, time.January, 31))
		st.SetDayOfMonth(31)

		next := st.CalculateNextDate()

		// 2024 is a leap year
		expected := NewDate(2024, time.February, 29)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Quarterly adds 3 months", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyQuarterly, NewDate(2024, time.January, 15))

		next := st.CalculateNextDate()

		expected := NewDate(2024, time.April, 15)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Yearly adds 1 year", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyYearly, NewDate(2024, time.January, 15))

		next := st.CalculateNextDate()

		expected := NewDate(2025, time.January, 15)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
	...
	t.Run("Yearly with interval 2", func(t *testing.T) {
		...
		expected := NewDate(2026, time.January, 15)
		if !next.Equal(expected) {
			t.Errorf("Expected %s, got %s", expected.String(), next.String())
		}
	})
...
func TestAdvanceSchedule(t *testing.T) {
	...
	t.Run("Returns false when next date would be past end date", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, NewDate(2024, time.December, 15))
		st.SetEndDate(NewDate(2024, time.December, 31))
	...
	t.Run("Multiple advances work correctly", func(t *testing.T) {
		...
		expected := NewDate(2024, time.January, 22)
		if !st.NextDate.Equal(expected) {
...
func TestScheduledTransactionValidation(t *testing.T) {
	validScheduledTransaction := func() *ScheduledTransaction {
		return NewScheduledTransaction(NewID(), FrequencyMonthly, Today())
	}
	...
	t.Run("End date before start date fails validation", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, NewDate(2024, time.June, 15))
		st.EndDate = NullableDate{Date: NewDate(2024, time.January, 1), Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("End date equal to start date fails validation", func(t *testing.T) {
		startDate := NewDate(2024, time.June, 15)
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, startDate)
		st.EndDate = NullableDate{Date: startDate, Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("Zero occurrences fails validation", func(t *testing.T) {
		st := validScheduledTransaction()
		st.Occurrences = NullableInt{Int64: 0, Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("Negative occurrences fails validation", func(t *testing.T) {
		st := validScheduledTransaction()
		st.Occurrences = NullableInt{Int64: -5, Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("Both end date and occurrences fails validation", func(t *testing.T) {
		st := NewScheduledTransaction(NewID(), FrequencyMonthly, NewDate(2024, time.January, 1))
		st.EndDate = NullableDate{Date: NewDate(2025, time.December, 31), Valid: true}
		st.Occurrences = NullableInt{Int64: 12, Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("Invalid day_of_month fails validation", func(t *testing.T) {
		...
		for _, dom := range testCases {
			st := validScheduledTransaction()
			st.DayOfMonth = NullableInt{Int64: dom, Valid: true}
			errs := st.Validate()
			if !errs.HasErrors() {
	...
	t.Run("Invalid day_of_week fails validation", func(t *testing.T) {
		...
		for _, dow := range testCases {
			st := validScheduledTransaction()
			st.DayOfWeek = NullableInt{Int64: dow, Valid: true}
			errs := st.Validate()
			if !errs.HasErrors() {
	...
	t.Run("Zero amount_estimate_count fails validation", func(t *testing.T) {
		st := validScheduledTransaction()
		st.AmountEstimateCount = NullableInt{Int64: 0, Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("Negative amount_estimate_count fails validation", func(t *testing.T) {
		st := validScheduledTransaction()
		st.AmountEstimateCount = NullableInt{Int64: -3, Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("Occurrences remaining exceeding occurrences fails validation", func(t *testing.T) {
		st := validScheduledTransaction()
		st.Occurrences = NullableInt{Int64: 10, Valid: true}
		st.OccurrencesRemaining = NullableInt{Int64: 15, Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("Memo exceeding max length fails validation", func(t *testing.T) {
		st := validScheduledTransaction()
		st.Memo = NullableString{String: string(make([]byte, 1001)), Valid: true}
		errs := st.Validate()
		if !errs.HasErrors() {
	...
	t.Run("All frequencies pass validation", func(t *testing.T) {
		for _, freq := range AllFrequencies() {
			st := NewScheduledTransaction(NewID(), freq, Today())
			errs := st.Validate()
			if errs.HasErrors() {
...
func TestScheduledTransactionUpdatesTimestamp(t *testing.T) {
	...
	t.Run("SetAmount updates timestamp", func(t *testing.T) {
		...
		st.SetAmount(MustNewMoney("-100.00"))
