// Package account holds the `tmoney account` command group (add, balance,
// close, delete, edit, list, reopen, show). It is one of the per-noun CLI subpackages
...
// (`add`, `balance`, `close`, `delete`, `edit`, `list`, `reopen`, `show`) are
