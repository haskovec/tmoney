...
func TestBuildMergerDialog_NewDialog(t *testing.T) {
	...
	// dialog.Field 0: Source Security (typeahead combo)
	...
	// dialog.Field 1: Target Security (typeahead combo)
	...
	// dialog.Field 3: Exchange Ratio (text, required)
	...
	// dialog.Field 4: Cash Per Share (text, optional)
