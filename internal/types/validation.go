...
// AddError adds a validation error directly. This is useful when calling
// from external packages that cannot access the unexported errors field.
...
// ServiceValidationError wraps validation errors for service-layer use.
