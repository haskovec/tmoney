study README.md
study specs/implementation-plan-investment-total-return.md and pick the most important thing to do
...
- update the implementation-plan-investment-total-return.md file marking the task as done
